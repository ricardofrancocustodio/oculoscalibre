...
- Remoção dos boxes de keywords abaixo da tabela para evitar confusão entre resultados de pesquisa e campos internos do briefing editorial.
...
6. Removidos os cards visuais de keyword principal/secundária da Skill 1.
7. Ajustado o fallback mock para retornar sugestões relacionadas por termos em comum, não apenas correspondência exata da frase buscada.
